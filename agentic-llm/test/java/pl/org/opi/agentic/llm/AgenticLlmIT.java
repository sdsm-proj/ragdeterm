...
public class AgenticLlmIT {
    ...
    void runTest() {
        ...
        JavaInheritanceExtractor rawExtractor =
                AiServices.builder(JavaInheritanceExtractor.class)
                        .chatModel(chatModel)
                        .build();

        CachedExtractor extractor = new CachedExtractor(rawExtractor);
        ...
        System.out.println("LLM call count: " + CachedExtractor.llmCallCount);
