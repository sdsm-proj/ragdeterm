...
import pl.org.opi.ragdeterm.repo.ctx.CooperationCtxRepox;
...
@Slf4j
public class CooperationContextService {
    ...
    public String exec(String canonicalBaseClassName, String preferredJarSimpleName, EnumAnswerType answerType, String prefix, String suffix, String separator) {
        try (var trx = DbConnContainer.newTrx()) {
            var cooperationCtxRepox = new CooperationCtxRepox(trx);
            LinkedHashSet<String> structureIds = cooperationCtxRepox.findCooperationOfType(canonicalBaseClassName, preferredJarSimpleName);
